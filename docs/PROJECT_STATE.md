...
| **P17-8 Package 3** Manual post-shipped completion loop | 🔄 **Open — prod verified (Mohamed)** | [P17-8-pkg3-post-shipped-loop.md](./architecture/P17-8-pkg3-post-shipped-loop.md) · commit `655ad37` · redeploy `dpl_4QJGtC82koEPUzyDCGrjbGuoz92B` |
| **P17 Listing Lifecycle & Retention** | 🔄 **Open — implementation** | [P17-listing-lifecycle-retention.md](./architecture/P17-listing-lifecycle-retention.md) · seller `archived_by_seller` · chat fresh-start cache · pending deploy + prod verify |
| **P17 Listing Lifecycle & Retention** | 🔄 **Open — implementation** | [P17-listing-lifecycle-retention.md](./architecture/P17-listing-lifecycle-retention.md) · `archived_by_seller` · chat cache SSOT · pending deploy |
| **P17-8 Package 4+** Extended tracking (carrier webhooks · SLA) | ⏳ **Not opened** | Deferred |
