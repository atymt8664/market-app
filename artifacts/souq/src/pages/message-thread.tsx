...
export default function MessageThread() {
  ...
  return (
    <div className="flex flex-col w-full h-[100dvh] bg-background">
      <header className="sticky top-0 z-40 bg-background border-b border-border p-3 flex items-center gap-3">
        <button
      ...
      <form
        onSubmit={handleSend}
        className="border-t border-border bg-background p-2 flex gap-2 items-end"
