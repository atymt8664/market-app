...
type BuyerOrderAddressCardProps = {
  address: OrderBuyerAddress;
};

export function BuyerOrderAddressCard({ address }: BuyerOrderAddressCardProps) {
  return (
    <div
      className={cn(ORDERS_CARD_COMPACT, "py-3")}
      data-testid="p17-order-detail-buyer-address-full"
    >
