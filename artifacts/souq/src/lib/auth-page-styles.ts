 ...
 * استخدم الق-values كسلاسل Tailwind جاهزة مع `cn()`.
 ...
 * Auth/guest page root — L2 scroll owner when App Shell locks document scroll (P9-3).

 * min-h-0 flex-1 fills the content slot; overflow-y-auto is the sole vertical scroll surface.
...
/** L1 auth/guest chrome — compact approved header bar. */

export const AUTH_HEADER = TAB_PAGE_HEADER_BAR;



/** Compact auth header inner row. */

export const AUTH_HEADER_INNER = TAB_PAGE_HEADER_AUTH_INNER;



export const AUTH_HEADER_TITLE_WRAP = TAB_PAGE_HEADER_SETTINGS_TITLE;

/** Plain title text — legacy admin pages that override size locally. */
export const AUTH_HEADER_TITLE = "text-lg font-bold text-foreground";



export const AUTH_HEADER_TITLE_BADGE = TAB_PAGE_TITLE_BADGE_COMPACT;



export const AUTH_HEADER_TRAILING = TAB_PAGE_HEADER_TRAILING_WRAP_COMPACT;



/** زر الرجوع — compact circular back */

export const AUTH_BACK_BUTTON = TAB_PAGE_HEADER_ACTION_BTN_DARK;



export const AUTH_HEADER_ACTION_ICON = TAB_PAGE_HEADER_ACTION_ICON;
...
/** @deprecated compact badge alias for admin pages that override size */

export const AUTH_HEADER_TITLE_LEGACY = "text-lg font-bold text-foreground";
