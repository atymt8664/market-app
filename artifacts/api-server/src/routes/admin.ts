...
import { parseStatsPeriod } from "../lib/admin-analytics-compute";
import { resolveAdminAnalytics } from "../lib/analytics-rollup";
...
async function handleAdminAnalytics(req: import("express").Request, res: import("express").Response) {
  ...
  const statsPayload = await resolveAdminAnalytics(period);
