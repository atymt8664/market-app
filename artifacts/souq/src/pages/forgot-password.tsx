  ...
  return (
    ...
    >
      <header className={AUTH_HEADER}>
        ...
        <h1 className={AUTH_HEADER_TITLE}>استعادة كلمة المرور</h1>
      </header>
      ...
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col gap-6 px-4 pb-8 pt-6 sm:px-5">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className={cn(AUTH_HERO_CARD, "w-full max-w-md space-y-1.5 text-center")}>
            <h2 className="text-lg font-bold md:text-xl">نسيت كلمة المرور؟</h2>
        ...
        {submitted ? (
          <div className={AUTH_CARD}>
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                إذا كان البريد الإلكتروني مسجلاً لدينا، فستجد رسالة تتضمّن رابطاً لإعادة تعيين كلمة المرور خلال
                دقائق.
              </p>
              <Link href="/login" className="w-full">
                <Button
                  type="button"
                  variant="ghost"
                  className={cn(AUTH_ACCENT_OUTLINE_BTN, "inline-flex items-center justify-center font-semibold hover:bg-zinc-900")}
                >
          ...
          <div className={AUTH_CARD}>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4" dir="rtl">
                <FormField
                ...
                >
                  {isSubmitting ? <Loader2 className="h-5 w-5 animate-spin" /> : "إرسال رابط الاستعادة"}
                </Button>
                <Link href="/login" className="text-center text-sm text-muted-foreground hover:text-primary hover:underline">
