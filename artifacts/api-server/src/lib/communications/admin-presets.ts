import type { AdminPresetContext } from "./types";

/**
 * Official Admin Response Presets — Mohamed approved (P17-9-7).
 * Arabic literals are the canonical source; i18n keys mirror these in souq locales.
 */
export const ADMIN_RESPONSE_PRESETS: Record<AdminPresetContext, readonly string[]> = {
  reports: [
    "تم اتخاذ الإجراء المناسب.",
    "تمت إزالة المحتوى المخالف.",
    "تم تحذير المستخدم.",
    "تم تعليق الحساب.",
    "لم يتم العثور على مخالفة.",
    "تمت مراجعة البلاغ وإغلاقه.",
  ],
  support: [
    "تم حل المشكلة.",
    "تم تحديث الحساب.",
    "تم استعادة الوصول للحساب.",
    "تم تحويل الطلب للمراجعة المتخصصة.",
    "بانتظار معلومات إضافية منك.",
  ],
  verification: [
    "تم قبول التوثيق.",
    "تم رفض التوثيق.",
...
export const ADMIN_PRESET_I18N_KEYS: Record<AdminPresetContext, readonly string[]> = {
  reports: [
...
export function getAdminPresetsForContext(context: AdminPresetContext): readonly string[] {
  return ADMIN_RESPONSE_PRESETS[context];
}
