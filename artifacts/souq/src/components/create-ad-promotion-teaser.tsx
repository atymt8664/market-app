...
export function CreateAdPromotionTeaser({
  ...
  return (
    <div className={SHELL} dir={dir}>
      <div className={cn("flex flex-col gap-2", textStart)}>
        <div className="flex min-w-0 flex-1 gap-2" dir={dir}>
          ...
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <ul className={cn("list-inside list-disc space-y-0.5 text-[11px] leading-snug text-zinc-400 md:text-xs", textStart)}>
