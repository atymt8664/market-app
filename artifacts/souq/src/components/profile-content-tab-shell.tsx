...
type ProfileContentTabShellProps = {
  ...
  panelScrollRef?: Ref<HTMLDivElement>;
  children?: ReactNode;
};
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          panelScrollable &&
            "min-h-0 flex-1 overflow-x-hidden overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch] souq-scrollbar-hidden",
        )}
      >
        {children}
      </div>
