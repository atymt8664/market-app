...
| NOC CPU row | ✅ Live load 1m | **P8-1H** — `snapshotServerMetrics` · VPS image `souq-api:p8-1h-20260531` |
...
| P8-1G | Billing/plans boundary doc (**P10**) | ✅ Closed |
| P8-1H | Monitoring boundary + NOC CPU hook | ✅ Closed |
