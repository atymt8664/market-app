...
| P15-3 Hot path migration | ⏳ **Open** | P15-3A ✅ · P15-3B ✅ · **P15-3C** ✅ (in commit) · cron/media deferred |
...
P15-3B — **Closed** (commit `c4acc54`): in-app notification outbox on STAGING (`notify.in_app`). Parent **P15-3 open** — push unification/cron remain.
